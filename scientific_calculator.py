...
bttn_0 = Button(calc,height =2,width=4,padx=10, pady = 10, text = "0",bg="steel blue")
...
mult["command"] = lambda: sum1.operation("multiplication")
...
point = Button(calc,height =2,width=4,padx=10, pady = 10, text = ".",bg="steel blue")
point["command"] = lambda: sum1.num_press(".")
point.grid(row = 4, column = 1, padx=1, pady = 1)

neg= Button(calc,height =2,width=4,padx=10, pady = 10, text = "+/-",bg="steel blue")
neg["command"] = sum1.sign
neg.grid(row = 4, column = 2,  padx=1, pady = 1)


clear = Button(calc,height =2,width=4,padx=10, pady = 10, text = "C",bg="green")
clear["command"] = sum1.clear
clear.grid(row = 1, column = 4,  padx=1, pady = 1)

all_clear = Button(calc,height =2,width=4,padx=10, pady = 10, text = "AC",bg="green")
